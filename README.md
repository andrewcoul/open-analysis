...
Bundled third-party components, including the Switzer font files in
`crates/oa-gui/assets/fonts/`, remain under their own licenses and are not
covered by the above. See [THIRD_PARTY.md](THIRD_PARTY.md).
